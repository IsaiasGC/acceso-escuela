...
class ListaAcceso extends Component {
    ...
    componentDidMount() {
        this.getHoy().then(() => this.getAusentes());
    }
    getHoy = async () => {
    ...
    getAusentes = () => {
        fetch("http://localhost:4000/api/alumnos/ausentes/" + this.state.hoy.id, {
            method: 'GET',
            mode: 'cors',
            credentials: 'same-origin',
        })
    ...
    marcarAsistencia = (data, comentario = "") => {
        var body = {
        ...
        // console.log(body);
        fetch("http://localhost:4000/api/listas/acceso/", {
            method: 'post',
            mode: 'cors',
            credentials: 'same-origin',
            headers: {
                                                    ...
                                                    <Card>
                                                        <Card.Body>
                                                            <Row>
                                                                ...
                                                                <Col md={4}>
                                                                    {/* <Button variant="success" onClick={(e)=>{this.marcarAsistencia(dato);}}>
                                                            Asistencia <i class="fas fa-check"></i>
                                                        </Button> */}
                                                                    <RegistroEntrada alumno={dato} marcarAsistencia={this.marcarAsistencia} />
                                                                </Col>
                                                            </Row>
                                                        </Card.Body>
                                                    </Card>
